...
#suffle the data to split the model better
randomiser <- runif(nrow(rawDF))
rawDF <- rawDF[order(randomiser),]
...
cleanDF$Category <- factor(cleanDF$Category, levels = c("0=Blood Donor", "0=suspect Blood Donor","1=Hepatitis","2=Fibrosis","3=Cirrhosis"), labels = c("Blood Donor", "Blood Donor","Hepatitis","Hepatitis","Hepatitis")) 
head(cleanDF, 10)
```
```{r}
